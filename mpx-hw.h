...
#define MPX_BOUNDS_TABLE_SIZE_BYTES		(1UL << 14) /* 16k */
#define MPX_BOUNDS_DIR_ENTRY_SIZE_BYTES		4
#define MPX_BOUNDS_DIR_SIZE_BYTES		(1UL << 22) /* 4MB */
...
#define MPX_BOUNDS_TABLE_SIZE_BYTES		(1UL << 22) /* 4MB */
#define MPX_BOUNDS_DIR_ENTRY_SIZE_BYTES		8
#define MPX_BOUNDS_DIR_SIZE_BYTES		(1UL << 31) /* 2GB */
